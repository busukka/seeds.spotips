		...
		<div class="container">
			<div class="row row1">
				<ul class="largenav pull-right">
					...
					<li class="upper-links"><a class="links" href="wow">사진</a></li>
					<!-- 로그인한 회원프로필사진,링크는마이페이지로 -->
					<li class="upper-links"><a class="links" href="wow">운동사랑</a></li>
					<!-- 로그인한 회원이름,링크는마이페이지로 -->
					<li class="upper-links"><a class="links" href="wow">알림</a></li>
					<!-- ajax로 알림창로딩 -->
					<li class="upper-links"><a class="links" href="wow">친구추천</a></li>
					<!-- ajax로 친구추천창 로딩 -->
					<li class="upper-links"><a class="links" href="wow">채팅</a></li>
					<!-- ajax로 채팅창 로딩 -->
					<li class="upper-links"><a class="links" href="wow">개인정보수정</a></li>
					<!-- 로그인한 회원이 일반이면 개인정보수정페이지로, 기업이면 기업정보수정페이지로 링크 이동 -->
			...
			<div class="row row2">
				<div class="col-sm-2">
					<h2 style="margin: 0px;">
						<span class="smallnav menu" onclick="openNav()">☰ Brand</span>
					</h2>
					<h1 style="margin: 0px;">
						<span class="largenav">SPOTIPS</span>
					</h1>
				</div>
